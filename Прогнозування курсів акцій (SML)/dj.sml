...
fun main()=
let 
  val NUMPAT=ref 30 (*Число шаблнов, может быть прочитано из файла*)
  and f=TextIO.openIn("C:/Program Files (x86)/Moscow ML/bin/etalons.txt")
in 
  (*Читаем с файла*)
  NUMPAT := read_int f;
  NUMIN := read_int f;
  ...
  NUMHID := !NUMIN * 2 + 1; (*Нейронов на скрытом слое*)
